...
IF_BUTTON(APPLET(button, BB_DIR_USR_SBIN, BB_SUID_DROP))
IF_BUTTONDSR(APPLET(buttondsr, BB_DIR_USR_SBIN, BB_SUID_DROP))
IF_LGCONTROL(APPLET(lgcontrol, BB_DIR_USR_SBIN, BB_SUID_DROP))
IF_BUZZER(APPLET(buzzer, BB_DIR_USR_SBIN, BB_SUID_DROP))
...
IF_I2CDETECT(APPLET(i2cdetect, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_I2CDETECT(APPLET(i2cget, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_I2CDETECT(APPLET(i2cset, BB_DIR_USR_BIN, BB_SUID_DROP))
...
IF_MIXER(APPLET(mixer, BB_DIR_USR_BIN, BB_SUID_DROP))
...
IF_WAVPLAY(APPLET(wavplay, BB_DIR_USR_BIN, BB_SUID_DROP))
